...
cleaned_user_data = cleaner.clean_user_data(extractor, connector)
cleaned_card_data = cleaner.clean_card_data(extractor)
cleaned_store_data = cleaner.clean_store_data(extractor)
cleaned_product_data = cleaner.clean_products_data(extractor)
cleaned_order_data = cleaner.clean_orders_data(extractor, connector)
cleaned_date_details = cleaner.clean_date_details(extractor)
